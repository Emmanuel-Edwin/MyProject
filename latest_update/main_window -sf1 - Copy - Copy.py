...
if login:
    ...
    class tempchar():
        ...
        def blit(self,screen):
            screen.blit(self.ptemprect_image,(tempchar.x+10,tempchar.y-150))
    ...
    while True:
        ...
        if game_status==1:
            ...
            if player_rect.colliderect(bullet_rect) and not player_rect.colliderect(main_character1.rect_rect_image):
                if len(Bullet_list)>0:
                    Bullet_list.pop(0)
                if len(Bullet_list)>0:
